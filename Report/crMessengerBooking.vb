...
Public Class crMessengerBooking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebMessenger.crMessengerBooking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMessengerBooking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMessengerBooking = New crMessengerBooking()
        rpt.Site = Me.Site
        Return rpt
    End Function
